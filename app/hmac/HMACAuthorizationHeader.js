...
export default class HMACAuthorizationHeader {
  ...
  constructor(realm, id, nonce, version, headers, signature, deviceId) {
    this.realm = realm;
    this.id = id;
    this.nonce = nonce;
  ...
  getAuthorizationString() {
    ...
    if (
      ...
      authBuilder.push(',deviceid="');
      authBuilder.push(this.deviceId);
      authBuilder.push('"');
    }
  ...
  toString() {
    const result = this.getAuthorizationString();
    return result;
  }
}
