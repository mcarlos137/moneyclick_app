...
//HOOKS
import { updatePassword } from '../../main/hooks/updatePassword';
import { signInProcess } from '../../main/hooks/signInProcess';

const ForgotPasswordProcessScreen = ({ navigation, route }) => {
    ...
    const [processLabel, setProcessLabel] = useState('Changing Password')
    ...
    //EFFECTS
    useEffect(() => {
        console.log('ForgotPasswordProcessScreen', route.params)
        let time = 0
...
export default React.memo(ForgotPasswordProcessScreen);
